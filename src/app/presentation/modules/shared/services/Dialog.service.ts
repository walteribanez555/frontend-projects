...
export class DialogService {
  ...
  open(dialog: Dialog) {
    ...
    if (dialog.typeDialog) {
      ...
      switch (dialog.typeDialog) {
        case DialogType.isAlert:
          dialogComponent.iconUrl =
            'assets/icons/heroicons/outline/exclamation.svg';
          dialogComponent.colorIcon = 'text-orange-500';
          break;

        case DialogType.isSuccess:
          dialogComponent.iconUrl =
            'assets/icons/heroicons/outline/check-badge.svg';
    ...
    if (dialog.options) {
      ...
      dialogComponent.timerClose$ = dialog.options.timeToShow
        ? dialog.options.timeToShow
        : null;
